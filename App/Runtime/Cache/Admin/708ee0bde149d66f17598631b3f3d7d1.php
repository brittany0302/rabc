...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：系统设置&nbsp;&nbsp;>&nbsp;&nbsp;权限添加</td>
  </tr>
  <tr>
    <td align="left" valign="top" id="addinfo">
    <a href="<?php echo U('Auth/add');?>" target="mainFrame" onFocus="this.blur()" class="add">新增权限</a>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="<?php echo U('addAction');?>">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
          <select name="auth_pid" id="level">
            <option value="0" >&nbsp;&nbsp;根节点</option>
            <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val['auth_id']); ?>" >&nbsp;&nbsp;<?php echo ($val['p']); echo ($val['auth_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
...
<script>
  ...
  $('#level').change(function () {
      var level = $('#level').val();
      if(level>0){
          //只有父类id不是0,说明它是子节点,那么显示
          $('.trhide').show();
      }else{
          //当父类id为0时,说明添加的是根节点,那么隐藏
          $('.trhide').hide();
      }
